...
2. You have injected malicious shell code into a website. Is the shell you receive likely to be interactive? (Y or N) `N`
...
1. Which option tells netcat to *listen*? `-l`
