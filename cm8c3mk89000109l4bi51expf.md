---
title: "Web Fundamentals: Upload Vulnerabilities (TryHackMe)"
datePublished: Sun Mar 16 2025 20:39:14 GMT+0000 (Coordinated Universal Time)
cuid: cm8c3mk89000109l4bi51expf
slug: web-fundamentals-upload-vulnerabilities-tryhackme
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1742157482176/149b00b1-1dfd-41ac-bf43-b1b78078d053.png
tags: tryhackme, write-up, webhacking, uploadvulnerabilities

---

This article will cover the [Upload Vulnerabilities](https://tryhackme.com/room/uploadvulns) write-up under the Web Fundamentals on THM.
...
If you've successfully deployed the machine then the following code blocks will already have the IP address filled in. If any of them have "MACH​INE\_IP" in them, then you still need to deploy the machine, and the following instructions will not work.
...
`10.10.10.10    overwrite.uploadvulns.thm shell.uploadvulns.thm java.uploadvulns.thm annex.uploadvulns.thm magic.uploadvulns.thm jewel.uploadvulns.thm demo.uploadvulns.thm   MACHINE_IP    overwrite.uploadvulns.thm shell.uploadvulns.thm java.uploadvulns.thm annex.uploadvulns.thm magic.uploadvulns.thm jewel.uploadvulns.thm demo.uploadvulns.thm   `
...
![](https://i.imgur.com/7KmsrTW.png align="left")
...
![](https://i.imgur.com/BeqAZ3s.png align="left")
...
![](https://i.imgur.com/8PiIuiu.png align="left")

![](https://i.imgur.com/TIoA2DR.png align="left")
...
1. What is the name of the image file which can be overwritten? `mountains.jpg`
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742151009531/6e6fb80e-0fc8-4ee5-b5fe-d6339713bccf.png align="center")
    
2. Overwrite the image. What is the flag you receive? `THM{OTBiODQ3YmNjYWZhM2UyMmYzZDNiZjI5}`  
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156278583/2d0d59cb-0403-4388-a34a-393aa5e4f159.png align="center")
    
    *Rename any image to mountains.jpg before uploading to overwrite the existing image inorder to find the flag*
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156303609/d84da3d3-68ba-43ab-9d86-88659beae0f8.png align="center")
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156376004/f8e5d4c2-cccd-41fb-9438-4900b9b6cd68.png align="center")
...
![](https://i.imgur.com/GxMJAKH.png align="left")
...
![](https://i.imgur.com/aAyIrod.png align="left")

![](https://i.imgur.com/mIbGRIk.png align="left")

Now, if we go to `http://demo.uploadvulns.thm/uploads` we should see that the spaniel picture has been uploaded!

![](https://i.imgur.com/lVe2tjL.png align="left")

![](https://i.imgur.com/N8vWlVO.png align="left")
...
![](https://i.imgur.com/CU0Uyx5.png align="left")
...
![](https://i.imgur.com/ysY306E.png align="left")
...
![](https://i.imgur.com/he0hbiR.png align="left")
...
1. Run a Gobuster scan on the website using the syntax from the screenshot above. What directory looks like it might be used for uploads? *(N.B. This is a good habit to get into, and will serve you well in the upcoming tasks...)* `/resources`  
    ...
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156550827/f897e477-bda1-4880-a144-a2c25ad85a93.png align="center")
    
2. Get either a web shell or a reverse shell on the machine. What's the flag in the /var/www/ directory of the server? `THM{YWFhY2U3ZGI4N2QxNmQzZjk0YjgzZDZk}`  
      
    edit the document to include the IP\_ADDRESS
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156633733/739e5efd-73a8-4a38-9454-3adc98f4a37c.png align="center")
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156670140/78ffba12-93f7-4a7c-bdca-0511fb0d7c0d.png align="center")
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742156747114/29373677-0810-4a8b-b8a8-5d4f11e493d9.png align="center")
...
* *MIME validation:* MIME (**M**ultipurpose **I**nternet **M**ail **E**xtension) types are used as an identifier for files -- originally when transfered as attachments over email, but now also when files are being transferred over HTTP(S). The MIME type for a file upload is attached in the header of the request, and looks something like this:  
    ...
    ![](https://i.imgur.com/uptWRKW.png align="left")
...
* *Magic Number validation****:*** Magic numbers are the more accurate way of determining the contents of a file; although, they are by no means impossible to fake. The "magic number" of a file is a string of bytes at the very beginning of the file content which identify the content. For example, a PNG file would have these bytes at the very top of the file: `89 50 4E 47 0D 0A 1A 0A`.  
    ...
    ![](https://i.imgur.com/vHQWOgi.png align="left")
...
1. What is the traditionally predominant server-side scripting language? `PHP`
    
2. When validating by file extension, what would you call a list of accepted extensions (whereby the server rejects any extension not in the list)? `Whitelist`
    
3. **\[Research\]** What MIME type would you expect to see when uploading a CSV file? `text/csv`
...
![](https://i.imgur.com/fI67jX0.png align="left")
...
![](https://i.imgur.com/TrI5jQD.png align="left")
...
![](https://i.imgur.com/T0RjAry.png align="left")
...
![](https://i.imgur.com/ACgWLpH.png align="left")
...
![](https://i.imgur.com/5cyqjqa.png align="left")
...
![](https://i.imgur.com/95hi6pX.png align="left")
...
![](https://i.imgur.com/sqmwssT.png align="left")
...
![](https://i.imgur.com/cUqNO2L.png align="left")
...
1. What is the flag in /var/www/? `THM{NDllZDQxNjJjOTE0YWNhZGY3YjljNmE2}`
...
![](https://i.imgur.com/yzOGVob.png align="left")
...
![](https://i.imgur.com/Aigaz4R.png align="left")
...
![](https://i.imgur.com/STsI51E.png align="left")
...
![](https://i.imgur.com/tp6T2WH.png align="left")
...
![](https://i.imgur.com/hk4inJ2.png align="left")
...
![](https://i.imgur.com/K55eu9o.png align="left")

Activating it, we receive our shell:

![](https://i.imgur.com/VVAKZfw.png align="left")
...
1. What is the flag in /var/www/? `THM{MGEyYzJiYmI3ODIyM2FlNTNkNjZjYjFl}`
...
![](https://i.imgur.com/yQnQGsn.png align="left")
...
![](https://i.imgur.com/2126EHS.png align="left")
...
![](https://i.imgur.com/oe434wu.png align="left")
...
![](https://i.imgur.com/otIyN96.png align="left")
...
![](https://i.imgur.com/2OlGKdQ.png align="left")
...
1. Grab the flag from /var/www/ `THM{MWY5ZGU4NzE0ZDlhNjE1NGM4ZThjZDJh}`
...
1. Hack the machine and grab the flag from /var/www/ `THM{NzRlYTUwNTIzODMwMWZhMzBiY2JlZWU2}`
