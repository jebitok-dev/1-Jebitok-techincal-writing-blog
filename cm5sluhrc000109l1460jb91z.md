...
![add call function graphic](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5ed5961c6276df568891c3ea-1732337854743.png align="left")
...
![Add call function intercepted by Frida](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5ed5961c6276df568891c3ea-1732337944825.png align="left")
...
![Connection details graphic](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5ed5961c6276df568891c3ea-1732571363622.png align="left")
...
![Glitch hacking the door](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732645396497.png align="left")
...
![Game Splash screen](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732294235507.png align="left")

Exploring the game a bit around, you will find a penguin asking for a PIN.

![First level game ](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732292354214.png align="left")

  

Terminate the previous game instance and execute the following Frida command to intercept all the functions in the [`libaocgame.so`](http://libaocgame.so) library where some of the game logic is present:

`frida-trace ./TryUnlockMe -i '`[`libaocgame.so`](http://libaocgame.so)`!*'`
...
Open a new terminal, go to the `/home/ubuntu/Desktop/TryUnlockMe/__handlers__/`[`libaocgame.so/`](http://libaocgame.so/) folder, and open Visual Studio Code by running:
...
![Visual Studio Code open with the scripts](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732815627110.png align="left")
...
![Inserting the OTP for the first level ](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732658605370.png align="left")
...
![Game image of the second stage showing the items to buy.](https://tryhackme-images.s3.amazonaws.com/user-uploads/5ed5961c6276df568891c3ea/room-content/5ed5961c6276df568891c3ea-1732808985706.png align="left")
...
![Game third level](https://tryhackme-images.s3.amazonaws.com/user-uploads/63c131e50a24c3005eb34678/room-content/63c131e50a24c3005eb34678-1732659104183.png align="left")
...
The following instruction will set it the return value to True:`retval.replace(ptr(1))`
