---
title: "The Advent of Cyber: Day 22: Kubernetes DFIR - It's because I'm kubed, isn't it? (TryHackMe)"
datePublished: Sun Jan 12 2025 13:38:47 GMT+0000 (Coordinated Universal Time)
cuid: cm5tnv75o000809lfcv7yg4ox
slug: the-advent-of-cyber-day-22-kubernetes-dfir-its-because-im-kubed-isnt-it-tryhackme
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1736689060111/efc0756b-4f05-4796-abd4-be74f24be74a.png
tags: kubernetes, tryhackme, write-up, dfir, adventofcyber2024
...
* **Digital Forensics**, like any other "forensics" discipline, aims to collect and analyze digital evidence of an incident. The artifacts collected from the affected systems are used to trace the chain of attack and uncover all facts that ultimately led to the incident. DFIR experts sometimes use the term "post-mortem" to indicate that their analysis starts *after* the incident has occurred and is performed on already compromised systems and networks.
...
Here we can see that most of the connections to our registry were made from the expected IP of 172.17.0.1, however, we can see that connections were also made by 10.10.130.253, which is not an IP known to us. Let's find all of the requests made by this IP:
...
McSkidy then sees a role binding named after Mayor Malware and decides to take a closer look:
...
8. Enjoy today's lesson? Check out our [Intro to Kubernetes](https://tryhackme.com/r/room/introtok8s) for a more in-depth introduction to Kubernetes!
