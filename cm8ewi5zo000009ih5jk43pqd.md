---
title: "Network Security: Active Reconnaissance (TryHackMe)"
datePublished: Tue Mar 18 2025 19:43:10 GMT+0000 (Coordinated Universal Time)
cuid: cm8ewi5zo000009ih5jk43pqd
slug: network-security-active-reconnaissance-tryhackme
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1742326948838/bed303bb-88f4-4003-a3a1-86943c3d6b16.png
tags: network-security, reconnaissance, tryhackme, write-up

---

This article will cover the [Active Reconnaissance](https://tryhackme.com/room/activerecon) write-up under the Web Fundamentals on THM.
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/f8b6de84195f6ce2a517b8985497e80f.png align="left")
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/cfe90ebdead91f2a1abd30833b22b001.png align="left")
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/02722e27a2e85fa803c2baa52ab54fdf.png align="left")
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/d8db9b9e278502db5ae2a6c12e79d890.png align="left")

Over time, you might find a few extensions that fit perfectly in your workflow.

### Answer the questions below

1. Browse to the following website and ensure that you have opened your Developer Tools on AttackBox Firefox, or the browser on your computer. Using the Developer Tools, figure out the total number of questions. `8`
...
4. Deploy the VM for this task and using the AttackBox terminal, issue the command `ping -c 10 MACHINE_IP`. How many ping replies did you get back? `10`
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742326904536/a494e189-3928-441c-8cd5-962b21e69d90.png align="center")
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/e82c42dcfae78ac592a8d7843465d2d6.png align="left")
...
![](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/948388c823b156813fa30225c2fa3f05.png align="left")
...
In the following examples, we run the same command, `traceroute` [`tryhackme.com`](http://tryhackme.com) from TryHackMe’s AttackBox. We notice that different runs might lead to different routes taken by the packets.
...
1. In Traceroute A, what is the IP address of the last router/hop before reaching tryhackme.com? `172.67.69.208`  
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742326796565/5e0d73b6-46af-49a3-945b-02b4a851c2da.png align="center")
    
2. In Traceroute B, what is the IP address of the last router/hop before reaching tryhackme.com? `104.26.11.229`  
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742326820148/d0e351ad-bf10-466e-838c-5c24e476ef42.png align="center")
    
3. In Traceroute B, how many routers are between the two systems? `26`  
...
1. Start the attached VM from Task 3 if it is not already started. On the AttackBox, open the terminal and use the telnet client to connect to the VM on port 80. What is the name of the running server? `Apache`
    
    ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1742326602414/6e7d044c-1462-4062-ad00-2a85a10b8157.png align="center")
    
2. What is the version of the running server (on port 80 of the VM)? `2.4.61`
...
1. Start the VM and open the AttackBox. Once the AttackBox loads, use Netcat to connect to the VM port 21. What is the version of the running server? `0.17`  
